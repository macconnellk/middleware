...
// ORIGINAL SIGMOID APPROACH: const tdd_factor = tdd_averages.weightedAverage / tdd_averages.average_total_data;
    ...
    const TDD_sigmoid_exponent = tdd_dev * TDD_sigmoid_adjustment_factor + TDD_sigmoid_fix_offset;
      var log_TDD_sigmoid_interval = "Log: TDD_sigmoid_interval: " + TDD_sigmoid_interval;
      var log_TDD_sigmoid_max_minus_one = "Log: TDD_sigmoid_max_minus_one: " + TDD_sigmoid_max_minus_one;
      var log_TDD_sigmoid_fix_offset = "Log: TDD_sigmoid_fix_offset: " + TDD_sigmoid_fix_offset;
      var log_TDD_sigmoid_exponent = "Log: TDD_sigmoid_exponent: " + TDD_sigmoid_exponent;
       
    // The TDD Factor sigmoid function
    const tdd_factor = TDD_sigmoid_interval / (1 + Math.exp(-TDD_sigmoid_exponent)) + TDD_sigmoid_min;
       var log_tdd_factor = "Log: tdd_factor: " + tdd_factor;
    ...
    const tdd_factor_strength_slider = 1;
       var log_tdd_factor_strength_slider = "Log: tdd_factor: " + tdd_factor;


    // The user adjusted TDD factor based on above % slider
    const modified_tdd_factor = ((tdd_factor - 1) * tdd_factor_strength_slider) + 1;
        var log_modified_tdd_factor = "Log: modified_tdd_factor: " + modified_tdd_factor;
...
// The Dynamic ISF Sigmoid Code 
      ...
      var log_minimumRatio = "Log: minimumRatio: " + minimumRatio;
      var log_maximumRatio  = "Log: maximumRatio: " + maximumRatio;
      var log_ratioInterval  = "Log: ratioInterval: " + ratioInterval;
      var log_max_minus_one  = "Log: max_minus_one: " + max_minus_one;
    ...
    const deviation = (myGlucose - (target / modified_tdd_factor)) * 0.0555; 
       var log_deviation  = "Log: deviation: " + deviation;
    ...
    const normal_cr = profile.carb_ratio;
      var log_normal_cr = "Log: normal_cr: " + normal_cr;
        ...
        const new_isf = profile.sens/autosens.ratio;
          var log_new_isf = "Log: new_isf: " + new_isf;
